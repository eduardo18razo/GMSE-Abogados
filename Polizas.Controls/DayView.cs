...
namespace Polizas.Controls
{
    public class DayView : Control
    {
        ...
        public List<Appointment> DataSource
        {
            get { return _mAppointments; }
            set { _mAppointments = value; }
        }
        ...
        {
            NewAppointmentEventArgs args = new NewAppointmentEventArgs(selectedAppointment.Title, selectedAppointment.StartDate, selectedAppointment.EndDate, 0);
        ...
        public void FinishEditing(bool cancel)
        {
            ...
            if (!cancel)
            {
                if (selectedAppointment != null)
                {
                    ...
                    dataUpdate.Text = selectedAppointment.Title;
                    _bcita.ActualizarCita(dataUpdate);
                }
            ...
            args.Appointments = _mAppointments;
